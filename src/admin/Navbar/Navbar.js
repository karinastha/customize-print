      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold">
          <li className="nav-item">
            <span className="nav-link active" padding-right='80px' aria-current="page" ><Link to="/order" style={{ textDecoration: "none", color: "white" }}> Order</Link></span>
          </li>
          <li className="nav-item">
            <span className="nav-link active" padding-right='80px' aria-current="page" > <Link to="/addnewproduct" style={{ textDecoration: "none", color: "white" }}>  Products </Link></span>
          </li>
