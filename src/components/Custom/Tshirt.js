...
export function Tshirt() {
    ...
    //Debugging
    // const [textcustomTshirt, setTextCustomTshirt] = useState({ text: ""});
    // const [imagecustomTshirt, setImageCustomTshirt] = useState({ image : ""});

    // const [texttshirts, setTexttshirts] = useState ([]);
    // const [imagetshirts, setImagetshirts] = useState();
                    ...
                    <table className="tshirt__image">
                        ...
                        {tshirts.map((tshirt, id) => {
                            return (
                                <div className="main__box">
                                    <tr key={id}>
                                        <td className="add__text"> {tshirt.text} </td>
                                        <td>
                                            {" "}
                                            <img className="add__image" src={tshirt.image} />{" "}
                                        </td>
                                    </tr>
                                </div>
                            );
